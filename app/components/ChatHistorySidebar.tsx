                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <button
                        ...
                        className="shrink-0 opacity-0 group-hover:opacity-100 p-1.5 text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all duration-200"
                        title="删除会话"
                      >
